#ifndef ENCLAVECLIENT_T_H__
#define ENCLAVECLIENT_T_H__
...
sgx_status_t verify_server_mrenclave(sgx_ra_context_t context, uint8_t* received_mrenclave, uint8_t* expected_mrenclave, int* match);
